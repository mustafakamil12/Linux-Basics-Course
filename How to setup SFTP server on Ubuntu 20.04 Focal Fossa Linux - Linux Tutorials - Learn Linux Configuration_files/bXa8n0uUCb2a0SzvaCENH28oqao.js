;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="795ee930d8dd752470c6dee7a81e91c1";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["pXVcwVlCghyp"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["pXVcwVlCghyp"].options={"anonymizeIp":false,"id":"UA-40602308-3","social":false};;CloudflareApps.installs["pXVcwVlCghyp"].URLPatterns=["^linuxconfig.org/?.*$","^www.linuxconfig.org/?.*$"];;if(CloudflareApps.matchPage(CloudflareApps.installs['pXVcwVlCghyp'].URLPatterns)){(function(){var options=CloudflareApps.installs['pXVcwVlCghyp'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("pXVcwVlCghyp"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
